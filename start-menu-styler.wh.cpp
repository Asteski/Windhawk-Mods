...
- theme: ""
  ...
  - CompactAllAppsGrid: Compact All Apps Grid
...
const Theme g_themeCompactAllAppsGrid = {{
    ThemeTargetStyles{L"Grid#TopLevelHeader", {
        L"Visibility=Collapsed",
        L"Height=0",
        L"MinHeight=0",
    ...
    ThemeTargetStyles{L"StartMenu.PinnedList", {
        ...
        L"MinHeight=0",
        L"Margin=0"}},
    ThemeTargetStyles{L"Grid#PinnedListHeaderGrid", {
        L"Visibility=Collapsed",
        L"Height=0",
        L"MinHeight=0",
        L"Margin=0"}},
    ...
    ThemeTargetStyles{L"Grid#ShowMorePinnedGrid", {
        ...
        L"MinHeight=0",
        L"Margin=0"}},
    ThemeTargetStyles{L"Button#ShowMorePinnedButton", {
        L"Visibility=Collapsed"}},
    ThemeTargetStyles{L"Microsoft.UI.Xaml.Controls.PipsPager#PinnedListPipsPager", {
        L"Visibility=Collapsed",
        L"Height=0",
    ...
    ThemeTargetStyles{L"GridViewHeaderItem", {
        ...
        L"Padding=0",
        L"Margin=0"}},
    ThemeTargetStyles{L"ListViewHeaderItem", {
        L"Visibility=Collapsed",
        L"Height=0",
        L"MinHeight=0",
        L"Padding=0",
    ...
    ThemeTargetStyles{L"GridView#AllAppsGrid > Border > ScrollViewer", {
        L"Margin=0"}},
    ThemeTargetStyles{L"GridView#AllAppsGrid > Border > ScrollViewer > Border#Root > Grid > ScrollContentPresenter#ScrollContentPresenter > ItemsPresenter > ItemsWrapGrid", {
        L"GroupPadding=0",
        L"AreStickyGroupHeadersEnabled=false",
        L"Margin=78,16,78,0"}},
    ThemeTargetStyles{L"GridView#AllAppsGrid > Border > ScrollViewer > Border > Grid > ScrollContentPresenter > ItemsPresenter > ItemsWrapGrid", {
        L"GroupPadding=0",
        L"AreStickyGroupHeadersEnabled=false",
        L"Margin=78,16,78,0"}},
    ThemeTargetStyles{L"StartDocked.AllAppsGridListView > ScrollViewer > Border#Root > Grid > ScrollContentPresenter#ScrollContentPresenter > ItemsPresenter > ItemsWrapGrid", {
        L"GroupPadding=0",
        L"AreStickyGroupHeadersEnabled=false"}},
    ThemeTargetStyles{L"GridView#AllAppsGrid > Border > ScrollViewer > Border#Root > Grid > Windows.UI.Xaml.Controls.Primitives.ScrollBar", {
        L"Visibility=Collapsed",
        L"Width=0",
        L"MinWidth=0",
        L"Margin=0"}},
    ThemeTargetStyles{L"StartDocked.AllAppsGridListView > ScrollViewer > Border#Root > Grid > Windows.UI.Xaml.Controls.Primitives.ScrollBar", {
        L"Visibility=Collapsed",
        L"Width=0",
        L"MinWidth=0",
        L"Margin=0"}},
    ThemeTargetStyles{L"MenuFlyoutItem[Text=Category]", {
        L"Visibility=Collapsed",
        L"Height=0",
        L"MinHeight=0",
        L"Margin=0"}},
    ThemeTargetStyles{L"ToggleMenuFlyoutItem[Text=Category]", {
        L"Visibility=Collapsed",
        L"Height=0",
        L"MinHeight=0",
        L"Margin=0"}},
...
const Theme* GetSelectedTheme(bool useNewLayoutVariant) {
    ...
    } else if (wcscmp(themeName, L"CompactAllAppsGrid") == 0) {
        theme = &g_themeCompactAllAppsGrid;
    }
