// ==WindhawkMod==
// @id              windows-11-lock-screen-styler
// @name            Windows 11 Lock Screen Styler
// @description     Customize the Lock Screen
// @version         1.0
// @author          m417z
...
- styleConstants: [""]
  ...
  $description: >-
    Style constants for customization. For technical details, refer to
    the mod description.
- controlStyles:
  - - target: ""
      $name: Target
        ...
        [weakElement = winrt::make_weak(element)]() {
            ...
            try {
                ...
                if (created && topLevelHeader) {
                    ...
                    // Lock screen instances opened in previous sessions of
...
void ProcessAllStylesFromSettings() {
    ...
    g_resourceVariables = ProcessResourceVariablesFromSettings(
        styleConstants, std::vector<PCWSTR>{});
}
...
int NTAPI RtlQueryFeatureConfiguration_Hook(UINT32 featureId,
    ...
    switch (featureId) {
        ...
        // Disable the revamped Lock screen experience.
    ...
    switch (disableNewStartMenuLayout) {
        ...
        case DisableNewStartMenuLayout::disableNewLayoutAndPhoneLink:
            ...
            if (IsMainModuleVersionAtLeast(10, 0, 26100, 8521)) {
                ...
                // in newer builds, and as a result, the Lock screen fails to
